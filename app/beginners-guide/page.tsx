...
export const metadata: Metadata = {
  title: 'Cairn Beginners Guide — Complete Guide (2026)',
  description: 'Comprehensive Cairn Beginners Guide guide covering climbing mechanics, stamina management, first ascent. Updated for 2026 with the latest strategies and tips.',
};

export default function BeginnersGuidePage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Cairn Beginners Guide</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Cairn Beginners Guide guide. This page covers everything you need to know about climbing mechanics, stamina management, first ascent.
      ...
      <section className="mb-10">
        ...
        <div className="mb-4 p-4 bg-bg-card rounded-lg border border-border">
          ...
          <p className="text-text-muted">
            Start with the tutorial and focus on learning the core mechanics. Our beginners guide above covers the essential first steps for getting started with Cairn.
          </p>
        </div>
