...
export const metadata: Metadata = {
  title: 'Cairn Map & Locations — Complete Guide (2026)',
  description: 'Comprehensive Cairn Map & Locations guide covering Mount Kami zones, camps, resources. Updated for 2026 with the latest strategies and tips.',
};

export default function MapLocationsPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Cairn Map & Locations</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Cairn Map & Locations guide. This page covers everything you need to know about Mount Kami zones, camps, resources.
