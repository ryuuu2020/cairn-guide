...
export const metadata: Metadata = {
  title: 'Cairn Survival Tips — Complete Guide (2026)',
  description: 'Comprehensive Cairn Survival Tips guide covering food, water, weather, bivouac, injuries. Updated for 2026 with the latest strategies and tips.',
};

export default function SurvivalTipsPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Cairn Survival Tips</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Cairn Survival Tips guide. This page covers everything you need to know about food, water, weather, bivouac, injuries.
