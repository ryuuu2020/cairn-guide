...
export const metadata: Metadata = {
  title: 'Cairn Gear & Equipment — Complete Guide (2026)',
  description: 'Comprehensive Cairn Gear & Equipment guide covering ropes, carabiners, ice axes, clothing tiers. Updated for 2026 with the latest strategies and tips.',
};

export default function GearEquipmentPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Cairn Gear & Equipment</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Cairn Gear & Equipment guide. This page covers everything you need to know about ropes, carabiners, ice axes, clothing tiers.
